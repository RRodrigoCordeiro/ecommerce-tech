  ...
  return (
    <div>
        ...
        {filterText("jamais,segurança, não fazemos, link falso, cobranças") && (
            <div className='grid  md:grid-cols-2 lg:grid-cols-4 gap-3 ml-8 mr-8  mt-28 mb-28'> 
        ...
        {filterText("Como identificar um perfil de site falso") && (
            <div> 
                <h2 className='text-center text-2xl font-bold mt-28'>Como identificar um perfil de site falso:</h2>
        ...
        {filterText("denunciar,denuncie, site falso") && (
            <div className='p-16 mt-28 bg-green-500'>
                <p className='text-center text-2xl font-bold p-3'>Denuncie!</p>
                <div className='flex flex-col md:flex-row justify-center items-center gap-8 '>
                    <p className='max-w-2xl text-justify mr-8'>Encontrou um site suspeito ou sofreu uma tentativa de golpe? Não ignore! Nos ajude a combater fraudes digitais denunciando páginas falsas. Sua colaboração é essencial para manter a internet mais segura e proteger outras pessoas de cair em armadilhas online. Juntos, podemos enfrentar esse problema.</p>
                    <div className='flex'>
        ...
        {filterText("forma de pagamento, pagamento, como pagar") && (
            <div>
                <h2 className='text-center text-2xl font-bold mt-28'>Forma de pagamento</h2>
                <div className='grid  md:grid-cols-2 lg:grid-cols-3 gap-3 ml-8 mr-8  mt-28 mb-28'> 
                    <div className='bg-white h-72   rounded-3xl text-center shadow-lg flex flex-col items-center justify-center'>
                        <FaPix className='mb-8 shadow-2xl block text-yellow-800' size={48}/>
                        <p className='text-center text-lg font-bold font-serif text-yellow-800  mb-8'>PIX</p>
                        <p  className='text-justify max-w-72 '>ferecemos a praticidade do Pix para você pagar de forma instantânea, segura e sem nenhuma taxa adicional.</p>
                    </div>

                    <div className='bg-white h-72   rounded-3xl text-center shadow-lg flex flex-col items-center justify-center'>
                        <FaRegCreditCard className='mb-8 shadow-2xl block text-yellow-800' size={48}/>
                        <p className='text-center text-lg font-bold font-serif text-yellow-800  mb-8'>CRÉDITO</p>
                        <p  className='text-justify max-w-72   '>Pague com cartão de crédito e parcele suas compras em até 10x sem juros, garantindo mais flexibilidade.</p>
                    </div>

                    <div className='bg-white h-72   rounded-3xl text-center shadow-lg flex flex-col items-center justify-center'>
                        <BsCreditCard className='mb-8 shadow-2xl block text-yellow-800' size={48}/>
                        <p className='text-center text-lg font-bold font-serif text-yellow-800  mb-8'>DÉBITO </p>
                        <p  className='text-justify max-w-72   '>Aceitamos cartões de débito para que você realize suas compras com rapidez e segurança.</p>
                    </div>
                </div>
            </div>
        )}
        ...
        {filterText("contato,entrar em contato,email") && (
            <div>
                <h2 className='text-center text-2xl font-bold mt-28'>Entre em contato </h2>
                <p className='text-center mt-8'>Entre em contato com o email:  <span className='text-gray-700  '>techzoneseguranca@gmail.com</span></p>
